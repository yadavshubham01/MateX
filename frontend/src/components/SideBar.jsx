...
function Sidebar() {
   ...
   const handleProfileClick = () => {
    navigate('/profile');  // Navigate to the 'publish' route
  };
  return (
    <div className="w-[20%] min-h-[100vh] p-4 gap-1 flex flex-col  border-gray-700 border-r border-l-0 border-[1px] border-t-0 border-b-0 space-y-6 bg-black">
      ...
      <button onClick={handleProfileClick} className="flex items-center  hover:bg-neutral-700  rounded-full py-2 px-4 font-semibold space-x-2">
