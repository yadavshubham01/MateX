...
function Sidebar() {
  ...
  return (
    <>
      ...
      <div
        className={`fixed top-0 left-0 h-full bg-black text-white flex flex-col p-4 space-y-6 z-40 transform ${
      ...
      >
        ...
        <button
          ...
          className="flex items-center hover:bg-neutral-700 rounded-full py-2 px-4 font-semibold space-x-2"
        >
        ...
        <button
          ...
          className="mt-4 w-[90%] px-5 py-3 bg-blue-500 hover:bg-blue-600 text-white rounded-full"
        >
          Post
        </button>
