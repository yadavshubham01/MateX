                ...
                <div className="mt-4">
                    {activeTab === "Posts" && (
                        <div>
                            {posts.length > 0 ? (
                                posts.map((post) => (
                                    <div key={post.id} className="w-full divide-neutral-600 divide-y ">
                                    <ProfilePost username={user.username} description={post.description} profileImage={user.profileImage} likes={post.likes.length} shares={post.shares.length}/>
                                 </div>
                                ))
                            ) : (
                                <p>No posts yet.</p>
                            ...
                            {likedPosts.length > 0 ? (
                                likedPosts.map((post) => (
                                    <div key={post.id} className=" divide-neutral-600 divide-y">
                                       <ProfilePost username={post.createdBy.username} description={post.description} profileImage={post.createdBy.profileImage} likes={post.likes.length} shares={post.shares.length}/>
                                    </div>
                                ))
                            ) : (
